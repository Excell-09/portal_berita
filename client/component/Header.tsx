    ...
    <AppBar position="static">
      <Toolbar>
        <Box sx={{ flexGrow: 1, display: { md: "flex", xs: "none" } }}>
          <Typography variant="h6" noWrap fontWeight={700} sx={{ display: "inline" }}>
        ...
        <Box sx={{ flexGrow: 1, display: { md: "none" } }}>
          <Tooltip title="Menu">
            <IconButton onClick={() => setIsNavOpen(true)} size="large" edge="start" color="inherit" aria-label="menu" sx={{ mr: 1 }}>
              <MenuIcon />
            </IconButton>
          </Tooltip>
          <Typography variant="h6" noWrap fontWeight={700} sx={{ display: "inline" }}>
          ...
          <Drawer anchor="left" open={isNavOpen} onClose={() => setIsNavOpen(false)} sx={{ display: { md: "none" } }}>
            <List sx={{ width: 200 }}>
              <ListItem disablePadding>
                <ListItemButton>
                  <Tooltip title="Menu">
                    <IconButton onClick={() => setIsNavOpen(false)} size="large" edge="start" color="inherit" aria-label="menu" sx={{ mr: 1 }}>
                      <MenuIcon />
                    </IconButton>
                  </Tooltip>
                </ListItemButton>
